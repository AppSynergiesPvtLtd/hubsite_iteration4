...
const StepFour = () => {
  ...
  return (
    <motion.section
      ...
      viewport={{ once: true, amount: 0.3 }} // Start animation when 30% of the section is in view
    ...
    >
        ...
        <div className="flex gap-0 md:gap-3 z-35 text-center w-fit">
          ...
          <div>
            ...
            >
              ...
              <h2 className={`${poppinsextrabold} text-[26px] lg:text-[36px] z-35`}>
                Enhanced Engagement
              </h2>
            </div>
            ...
            >
              The prospect of earning coins encourages regular participation,
              fostering a habit of providing feedback.
            </p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="relative flex justify-start md:justify-center items-center w-full md:w-fit md:p-10">
          ...
          {/* Second Image */}
          <motion.div
            className="p-3 rounded-lg z-1 absolute top-[20%] left-[60%]"
          // variants={imageHover}
          // whileHover="hover"
          >
      ...
      {/* Text Section for Smaller Screens */}
      <motion.div
