    ...
    <div className="w-[140px] h-[226px] sm:w-[230px] sm:h-[280px] md:w-[300px] md:h-[400px] relative">
      ...
      <div className='w-full sm:w-[400px] md:w-[500px] mt-4 ml-8lag md:mt-0'>
        ...
        <div className='mt-4 md:mt-1 sm:text-left'>
          <p className={`${poppinsextrabold}text-[18px] sm:text-[20px] md:ml-20 md:text-[24px] text-[#0057A1] px-4 sm:px-0`}>
            Allows for segmentation and targeting of specific demographics to improve survey relevance.
          </p>
        </div>
      </div>
    </motion.div>
