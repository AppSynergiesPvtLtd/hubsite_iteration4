...
const SurveySuccess = ({ heading: propHeading, message: propMessage }) => {
  const router = useRouter()
  const { t } = useTranslation('standalone')

  const heading = propHeading || t('template.heading')
  const message = propMessage || t('template.message')
