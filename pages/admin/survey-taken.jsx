...
import { clearTitle, hideAdd, hideExcel, hideRefresh, resetExcel, setTitle, showExcel } from "@/store/adminbtnSlice";
...
const SurveyTaken = () => {
  ...
  // Set default sortOrder to "Descending" so that the latest survey appears on top.
  const [sortOrder, setSortOrder] = useState("Descending");
  // tempSortOrder is used to store the modal’s selection before applying.
  ...
  useEffect(() => {
    dispatch(setTitle("Survey Taken"));
  ...
  const fetchSurveys = async () => {
    ...
    try {
      ...
      // Sort the fetched data by createdAt descending by default.
  ...
  // Apply the sort filter only when clicking "Apply" in the modal.
