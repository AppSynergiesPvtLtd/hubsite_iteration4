...
const ContactForm = () => {
  ...
  const validateForm = () => {
    ...
    if (file) {
      ...
      if (!allowedTypes.includes(file.type)) {
        newErrors.file = 'Only JPG and PNG images are allowed';
      }
    }
  ...
  return (
    <div className="flex flex-col mt-10 items-center justify-center px-3 poppins pt-3 2xl:min-h-[85vh]">
      {formSubmitted ? (
        ...
        <>
          <h1 className="text-3xl md:w-[330px] font-medium text-[#333333] text-center mb-6 poppins-bold ">
            ...
            <div className="w-full max-w-lg">
              <form className="space-y-4 mb-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className={`mt-1 w-full border ${errors.file ? 'border-red-500' : 'border-gray-300'} border-dashed rounded-lg p-4 text-center h-[100px]`}>
                    <input
                      type="file"
                      id="upload"
                      className="hidden"
                      ...
                      accept=".jpg, .jpeg, .png"
                    />
                    <label htmlFor="upload" className="text-[#0057A1] m-auto cursor-pointer hover:underline">
                      {formData.file ? (
