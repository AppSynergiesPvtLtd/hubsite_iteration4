      ...
      <div className="flex bg-white shadow-lg rounded-lg ">
        <div className="w-2/3 p-8">
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              <h2 className="text-[18px] text-gray-700 ">Full Name</h2>
            ...
            >
              {editingField === "fullName" ? "Set" : "Edit"}
            </button>
          </div>
          <hr className="mb-6" />
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            >
              {editingField === "phoneNumber" ? "Set" : "Edit"}
            </button>
          </div>
          <hr className="mb-6" />
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <span className="text-green-500 text-2xl font-semibold"><Icon4 />
            </span>
          </div>
          <hr className="mb-6" />
        ...
        <div className="w-1/3 flex flex-col items-center justify-center p-6 bg-gray-50">
          <h3 className="text-blue-600 font-semibold mb-4">Display Picture</h3>
